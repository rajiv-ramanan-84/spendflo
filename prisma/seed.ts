...
async function main() {
  ...
  console.log('Created users:', admin.name, manager.name);
  ...
  console.log('Created budgets:', engineeringBudget.department, salesBudget.department, marketingBudget.department);
  ...
  console.log('Created budget utilization records');
